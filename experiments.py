...
def rank():
    ...
    # Get top 10 neutral words for each dataset
...
def main():
    ...
    description=(
        ...
        "  structure_checking: The experiment checks the precision@k for LLMs and W2V models, and produces data for Figure 4 in Section 4.2 and Figure 5 in the Appendix.\n"
